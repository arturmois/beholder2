                                    ...
                                    <div className="row">
                                        <div className="col-md-6 mb-3">
                                            <div className="form-group">
                                                ...
                                                <input type="number" className="form-control" id="basePrecision" defaultValue={symbol.basePrecision} placeholder="8" required onChange={onInputChange} />
                                            </div>
                                        </div>
                                        <div className="col-md-6 mb-3">
                                            <div className="form-group">
                                                <label htmlFor="quotePrecision">Quote Precision:</label>
                                                <input type="number" className="form-control" id="quotePrecision" defaultValue={symbol.quotePrecision} placeholder="8" required onChange={onInputChange} />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="row">
                                        <div className="col-md-6 mb-3">
                                            <div className="form-group">
                                                ...
                                                <input type="text" className="form-control" id="minNotional" defaultValue={symbol.minNotional} placeholder="0.1" required onChange={onInputChange} />
                                            </div>
                                        </div>
                                        <div className="col-md-6 mb-3">
                                            <div className="form-group">
                                                <label htmlFor="minLotSize">Min Lot Size:</label>
                                                <input type="text" className="form-control" id="minLotSize" defaultValue={symbol.minLotSize} placeholder="0.1" required onChange={onInputChange} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
