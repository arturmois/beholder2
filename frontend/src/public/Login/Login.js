                            ...
                            <form action="#" className="mt-4" onSubmit={onSubmit}>
                                <div className="form-group mb-4">
                                    ...
                                    <div className="input-group">
                                        ...
                                        <input input type="email" className="form-control" placeholder="example@company.com" id="email" autofocus required onChange={onChangeInput} />
                                    </div>
                                </div>
                                <div className="form-group">
                                    ...
                                    <div className="d-flex justify-content-between align-items-top mb-4">
                                        ...
                                        <div>
                                            <Link to="/forgot-password" className="small text-right">Lost password?</Link>
                                        </div>
